...
RideStartModel rideStartModelFromJson(String str) => RideStartModel.fromJson(json.decode(str));

String rideStartModelToJson(RideStartModel data) => json.encode(data.toJson());
...
class RideStartModel {
  ...
  factory RideStartModel.fromJson(Map<String, dynamic> json) => RideStartModel(
